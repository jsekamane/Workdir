...
pdf(file="figure_capacity_firstyears.pdf", height=3.5, width=5)
plot(capacity$Germany, type="l", ylim=range(0,200), axes=F, ann=T, xlab="Years", ylab="MW", cex.lab=0.8, lwd=2)
...
title(main="Installed capacity of first 200 MW (MW)")
mtext("1990-2010");
