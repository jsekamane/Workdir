...
\begin{figure}
	...
	\Figsource{Eurostat (nrg\_113a). EWEA (2012)}
\end{figure}
...
\begin{table}
	...
	%\csvautotabular{Tables/table_avgwindspeeds.csv}
	\begin{tabular}{L|L L L L|L}
		\hline
		\textbf{DE} & \multicolumn{4}{c|}{\textbf{LT}} & \textbf{UK} \\
		Reference site & Average of test sites * & Giruliuose & Būtingėje & Coastal region ** & Existing wind farms *** \\
		\hline
		5.5 & 6.06 & 5.95 & 6.88 & 6.43 & 7.23 \\
		\hline
	\end{tabular}
	\Fignote{LT and UK wind speeds have been calculated at 30 m using the wind gradient equation with a Hellman exponent of 1/7. * Vilkyčiai, Kretinga, and Tauragė. ** Wind speeds from hydrometeorological stations measured at 10 m above ground. *** Wind speeds calculated using the DTI NOABL database.}
	\Figsource{UK: Butler and Neuhoff (2004, p. 13). DE: IEA (2000, p. 96). LT: Marciukatis (2011), Erlickytė-Marčiukaitienė, Marčiukaitis and Tumosa (2007, p. 27)}
...
%Simple test, where i refere to \citet{Baltpool2012} or how about this paper by \citet{Butler2008}. Thats great but \cite*{EWEA2011} is better. It might work better with.
